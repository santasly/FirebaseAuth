...
import com.example.firebaseauth.data.productviemodel
//import com.example.firebaseauth.data.productviewmodel
import com.example.firebaseauth.models.Product
import com.example.firebaseauth.navigation.ROUTE_UPDATE_PRODUCTS
...
fun ViewProductsScreen(navController:NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        var productRepository = productviemodel(navController, context)
...
fun ProductItem(name:String, quantity:String, price:String, id:String,
                navController:NavHostController, productRepository:productviemodel) {
